...
import static com.diablement.rest.constant.EmailConstant.*;
...
public class EmailService {
	...
	private Message createEmail(String firstname, String password, String email) throws AddressException, MessagingException {
		...
		message.setRecipients(Message.RecipientType.TO, InternetAddress.parse(email, false));//adresse de la prs à qui envoyer
