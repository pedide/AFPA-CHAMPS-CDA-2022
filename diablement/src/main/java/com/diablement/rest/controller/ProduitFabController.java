...
import com.diablement.rest.service.impl.ProduitFabServiceImpl;
...
public class ProduitFabController {
	...
	@PutMapping("/produit-fab")//mise à jour
	...
	//recupere un produitFab en fonction de id
	@GetMapping("/produit-fab/{idProduitFab}")
	public ResponseEntity findProduitFabById(@PathVariable(name="idProduitFab")
	Long idProduitFab) {
	...
	public ResponseEntity deleteProduitFab(@PathVariable(name="id")
	Long idProduitFab) {
