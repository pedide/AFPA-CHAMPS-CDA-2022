...
public class ExceptionHandling implements ErrorController{
	...
	private static final String INCORRECT_CREDENTIALS = "Username / password incorrect. Please try egain.";
	private static final String ACCOUNT_DISABLED = "Your account has been disabled. If this is an error, conatct administration";
	 ...
	 * exception) { return createHttpResponse(BAD_REQUEST,
