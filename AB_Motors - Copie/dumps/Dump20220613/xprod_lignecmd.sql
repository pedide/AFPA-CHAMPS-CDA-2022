...
CREATE TABLE `lignecmd` (
  `IDLIGNECM` int NOT NULL AUTO_INCREMENT,
  `NUMLIGNECMD` int DEFAULT NULL,
  `QTELIGNECMD` int DEFAULT NULL,
  `DATELIVRLIGNECMD` varchar(200) DEFAULT NULL,
  `PRIXUHTLIGNECMD` float DEFAULT NULL,
  PRIMARY KEY (`IDLIGNECM`)
