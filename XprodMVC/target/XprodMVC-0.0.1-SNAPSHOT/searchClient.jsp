...
<%@include file="includes/navbar.jsp"%>
		<!-- <div style="color:black; text-align:center; font-size:30px;">Search <i class="fa fa-home" ></i></div> -->
				...
				<div class="card w-80" style="width: 15rem;">
					<div class=contenairIMG style="width: 100px, height:100px">
						...
						<div class="card-body">
							...
							<a href="add-to-cart?id=<%=rs.getInt(1)%>" class="btn btn-dark">Ajouter au Panier</a> <a
								href="oreder-now?quantite=1&id=<%=rs.getInt(1)%>" class="btn btn-primary">Acheter</a>
