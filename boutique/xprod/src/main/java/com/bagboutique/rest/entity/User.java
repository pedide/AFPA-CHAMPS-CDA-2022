...
@Entity
//Serializable faire apel a une liste de donnée
public class User implements Serializable {
	@Id
	@GeneratedValue(strategy=GenerationType.AUTO)//c l'une des raisons pour laquele il m'	a crée la table hibernate_sequence dans la base de donnée
	@Column(nullable=false,updatable=false)
private Long id;//id for data base
...
private String [] authorities;//Are perssions:read, edit,delete
...
public void setLastLoginDate(java.util.Date lastLoginDate) {
	this.lastLoginDate = (Date) lastLoginDate;
}
