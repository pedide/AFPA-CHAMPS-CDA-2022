...
--
-- Table structure for table `produitappro`
--

DROP TABLE IF EXISTS `produitappro`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `produitappro` (
...
--
-- Dumping data for table `produitappro`
--

LOCK TABLES `produitappro` WRITE;
/*!40000 ALTER TABLE `produitappro` DISABLE KEYS */;
/*!40000 ALTER TABLE `produitappro` ENABLE KEYS */;
UNLOCK TABLES;
