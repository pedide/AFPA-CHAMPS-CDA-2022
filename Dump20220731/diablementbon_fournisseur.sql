...
CREATE TABLE `fournisseur` (
  ...
  `adressefour` varchar(255) DEFAULT NULL,
  `cpfour` varchar(255) DEFAULT NULL,
  `emailfour` varchar(255) DEFAULT NULL,
  `faxfour` varchar(255) DEFAULT NULL,
  `nomfournisseur` varchar(255) DEFAULT NULL,
  `paysfour` varchar(255) DEFAULT NULL,
  `raisonsocial` varchar(255) DEFAULT NULL,
  `telfour` varchar(255) DEFAULT NULL,
