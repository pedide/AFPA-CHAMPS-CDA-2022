...
--
-- Table structure for table `orderpr`
--

DROP TABLE IF EXISTS `orderpr`;
...
--
-- Dumping data for table `orderpr`
--

LOCK TABLES `orderpr` WRITE;
/*!40000 ALTER TABLE `orderpr` DISABLE KEYS */;
/*!40000 ALTER TABLE `orderpr` ENABLE KEYS */;
UNLOCK TABLES;
