...
public class ExceptionHandling implements ErrorController{
	...
	public ResponseEntity <HttpResponse> accountDisabledException() { //Lorsque l'utilisateur va se tromper 6 fois, il ne pourra plus se connecter
		return createHttpResponse(BAD_REQUEST, ACCOUNT_DISABLED);
	}
	
	@ExceptionHandler(BadCredentialsException.class)
	public ResponseEntity <HttpResponse> badCredentialsExceptionn() { 
	 ...
	 * <HttpResponse> noHandlerFoundException(NoHandlerFoundException exception) {
	 * 
	...
	public ResponseEntity<HttpResponse> notFound404(HttpStatus httpStatus, String message) {
		return createHttpResponse(NOT_FOUND, "There is no mapping to you URL");
	}
