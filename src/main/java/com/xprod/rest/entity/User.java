...
@Entity
public class User implements Serializable{ //fait appel à une liste de données
	@Id
	@GeneratedValue(strategy=GenerationType.AUTO)
	@Column(nullable=false, updatable = false)
	private Long id; //id pour la base de données
	private String userId; // id pour l'utilisateur
	...
	private String role; //role_user(edit, read), role_admin(delete)
	private String [] authorities; // sont permis de : read, edit, delete
