...
public class OrderDao {
	...
	public boolean insertOrder(Order model) {
		...
		try {
			query = "insert into orders (idProduct, idUsers, quantity, dateOrders, price, total, email) values (?,?,?,?,?,?,?)";	/*(idProduct, idUsers, quantity, dateOrders) values (?,?,?,?)";*/
			...
			pst.setDouble(5, model.getPrixU()); 
			pst.setDouble(6, model.getPrixU()* model.getQuantity() );
