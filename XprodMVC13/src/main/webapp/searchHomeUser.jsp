...
<div class="container">
	<div class="card-header my-3" style="background-color:#FFFAF0">Les produits trouvés sont :</div>
	<div class="row">
		...
		<div class="col md-3">
			<div class="card w-80" style="width: 18rem;">
				...
				<div class="card-body">
					...
					<h6 class="category"><%=rs.getString(4) %></h6>
					<div class="mt-3 d-flex justify-content-between"></div>
					<a href="add-to-cart?id=<%=rs.getString(1)%>" class="btn btn-outline-light" style="background:#B39188">Ajouter au panier</a> 
					<a href="order-now?quantity=1&id=<%=rs.getString(1)%>" class="btn btn-outline-info">Acheter maintenant</a> 
