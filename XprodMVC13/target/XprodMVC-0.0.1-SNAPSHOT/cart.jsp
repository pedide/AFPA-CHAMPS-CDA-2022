...
<!--  		<form action="cart-check-out" method="post">  -->
		...
		<% 
		if(auth == null){%>
			<p><button class="btn btn-pays btn-sm" style="background-color:green"; margin-left:5px;>Confirmer la commande</button></p>
		<%}else{%>
			<p><button class="btn btn-pays btn-sm" style="background-color:green"; margin-left:5px;>Info livraison et paiement</button></p>
...
<!-- 				data-name="Xprod E-shopping" -->
<!-- 				data-description="Checkout et Xprod paiement" -->
