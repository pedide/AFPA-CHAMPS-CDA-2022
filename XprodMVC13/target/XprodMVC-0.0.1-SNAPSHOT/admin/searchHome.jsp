		...
		<div class="col md-3">
			<div class="card w-80" style="width: 18rem;">
				...
				<div class="card-body">
					...
					<a href="editProduct.jsp?id=<%=rs.getString(1)%>" class="btn btn-outline-secondary">Edition <i class="fas fa-pen-fancy"></i></a>
				    <a href="../delete-product?id=<%=rs.getString(1)%>" class="btn btn-danger">Suppression <i class="fas fa-trash"></i></a> 
