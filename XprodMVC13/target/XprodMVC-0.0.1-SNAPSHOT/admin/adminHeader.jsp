...
<a href="allProductEditProduct.jsp">Tous les produits et Edition produit <i class="fas fa-plus-square"></i></a>
<a href="allMessagesUsers.jsp">Messages des clients <i class="fas fa-plus-square"></i></a>

<a href="../logout.jsp">Se déconnecter <i class="fas fa-share-square"></i></a>
